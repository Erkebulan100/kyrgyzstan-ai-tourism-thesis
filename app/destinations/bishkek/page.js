...
{/* Hero Section with Slider */}
      {/* <section className="relative h-[80vh] md:h-[200vh] flex items-center justify-center overflow-hidden -mt-[0px] md:-mt-[0px] pt-[0px] md:pt-[0px]"> */}
...
|--------|--------|----------------|
| Mobile | Tall & narrow | Crops left/right sides, fills height |
| Desktop | Wide | Shows more of image width |
```
Mobile (crops sides):          Desktop (shows more width):
┌─────────┐                    ┌─────────────────────────────┐
│ ┌─────┐ │                    │                             │
│ │crop │ │                    │     Full width visible      │
│ │ped  │ │                    │                             │
│ └─────┘ │                    └─────────────────────────────┘
└─────────┘ */}
      {/* Description Section */}
